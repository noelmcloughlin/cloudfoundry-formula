...
This installs the cloudfoundry solution.
...
This state will install the cloudfoundry-cli package only.

``cloudfoundry.cli.package.clean``
^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^

This state will uninstall the cloudfoundry-cli package only.

``cloudfoundry.cli.package.repo``
^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^

This state will install the cloudfoundry-cli package repository only.

``cloudfoundry.cli.package.repo.clean``
^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^

This state will uninstall the cloudfoundry-cli package repository only.

``cloudfoundry.cli.package.archive``
^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^

This state will install the cloudfoundry-cli package archive only.

``cloudfoundry.cli.package.archive.clean``
^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^

This state will uninstall the cloudfoundry-cli package archive only.
